  <section class="home">
    <div class="swiper bg-slider">
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <img src="<?= base_url('assets/pub/')?>images/photos/pic9.JPG" alt="pic1">
          <div class="text-content">
            <h2 class="title">Auntum <span>Season</span></h2>
        ...
        <div class="swiper-slide">
          <img src="<?= base_url('assets/pub/')?>images/photos/pic3.JPG" alt="pic2">
          <div class="text-content">
        ...
        <div class="swiper-slide">
          <img src="<?= base_url('assets/pub/')?>images/photos/pic6.JPG" alt="pic3">
          <div class="text-content">
        ...
        <div class="swiper-slide">
          <img src="<?= base_url('assets/pub/')?>images/photos/pic5.JPG" alt="pic4">
          <div class="text-content">
    ...
    <div class="bg-slider-thumbs">
      <div class="swiper-wrapper thumbs-container">
        <img src="<?= base_url('assets/pub/')?>images/bg1.jpg" class="swiper-slide" alt="">
        <img src="<?= base_url('assets/pub/')?>images/bg2.jpg" class="swiper-slide" alt="">
        <img src="<?= base_url('assets/pub/')?>images/bg3.jpg" class="swiper-slide" alt="">
        <img src="<?= base_url('assets/pub/')?>images/bg4.jpg" class="swiper-slide" alt="">
      </div>
    </div>
  </section>

  <section class="about section">
    <h2>Season of the year</h2>
