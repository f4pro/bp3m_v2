...
<div id="hero" class="hero overlay subpage-hero kegiatan-hero">
                            ...
                            <div class="post-content">
                                ...
                                <div class="post-meta">
                                    <span class="post-author">
                                        <a href="#"><i class="fa fa-map-marker" aria-hidden="true"></i><?= $b['tempat_kegiatan'];?></a>
                                    </span>
                                    <span class="post-date">
                                        <a href=""><i class="fa fa-calendar" aria-hidden="true"></i>
                                            <?php
                                                $oldDate = strtotime($b['waktu_kegiatan']);
                    ...
                    <div class="col-md-4">
						...
						?>
                                ...
                                <!-- <div class="widget widget-categories">
                                    ...
                                    <?php
							$query = "SELECT * FROM `kategori` ORDER BY id DESC LIMIT 5";
							$r = mysqli_query($con, $query);
							while ($row = mysqli_fetch_assoc($r)) {
						?>
