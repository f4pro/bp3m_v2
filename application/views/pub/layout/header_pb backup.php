                    ...
                    <nav class="navbar navbar-expand-md navbar-light">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav ml-auto py-4 py-md-0">
                                ...
                                <li class="nav-item pl-4 pl-md-0 ml-0 ml-md-4 ">
                                    <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button"
                                        aria-haspopup="true" aria-expanded="false">Layanan Umum</a>
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="<?=base_url('kegiatan_p')?>">Informasi Pelatihan</a>
                                        <a class="dropdown-item" href="https://survei.pcr.ac.id" target="_blank"><i class="fa fa-external-link"></i> Survei</a>
                                        <!-- <a class="dropdown-item disabled" href="#"><i class="fa fa-external-link"></i> SIAP [akan datang]</a> -->
                                    </div>
                                </li>
                                <li class="nav-item pl-4 pl-md-0 ml-0 ml-md-4 ">
