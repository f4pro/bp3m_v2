            ...
            <div class="card-body">
                <form action="" method="POST">
                    <div class="form-group">
                        ...
                        <input type="text" name="pertanyaan" value="<?= set_value('nama_ps'); ?>" class="form-control" id="kategori">
                    ...
                    <button type="submit" name="Tambah" class="btn btn-primary float-right">Tambah Pertanyaan</button>
                </form>
            </div>
        </div>
    </div>
