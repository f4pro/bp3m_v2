                ...
                <div class="card-body">
                    <form action="" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="judul" value="<?= $renbang['judul']; set_value('judul');?>" class="form-control" id="judul" placeholder="Judul">
                            <?= form_error('judul', '<small class="text-danger pl-3">', '</small>'); ?>
                        </div>
                        <div class="form-group">
                            <label for="nama">Isi Konten</label>
                            <textarea class="ckeditor" name="isi" id="ckedtor"><?= $renbang['isi']; set_value('isi');?></textarea>
